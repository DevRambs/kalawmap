            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Describe current ground conditions (e.g., saturated, muddy, dry with cracks)"
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                />
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              >
                <option value="">Select warning signal</option>
                <option value="Typhoon Warning Signal #1">Typhoon Warning Signal #1</option>
                <option value="Typhoon Warning Signal #2">Typhoon Warning Signal #2</option>
                <option value="Typhoon Warning Signal #3">Typhoon Warning Signal #3</option>
                <option value="Typhoon Warning Signal #4">Typhoon Warning Signal #4</option>
                <option value="Typhoon Warning Signal #5">Typhoon Warning Signal #5</option>
              </select>
            </div>
          </div>
